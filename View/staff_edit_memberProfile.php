            ...
            <div class="container">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ol>
                        ...
                        <li><a href="member_profile.php?Member_id=<?php echo $memberID; ?>">Member Profile</a></li>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <ul class="profilenav list-group rounded-0"
                                        ...
                                        <a href='member_profile.php?Member_id=<?php echo $memberID; ?>' class='list-group-item list-group-item-action px-2'>
                            ...
                            <div class="panel bg-light">
                                <div class="panel-body bio-graph-info row ms-2">
                                    ...
                                    <form id="editProfile" action="../Process/edit_profile_process.php" method="POST"
                                        ...
                                        <div class="bio-row">
                                            <label class="col-lg-9 control-label"
                                                name="user_email">Member email:</label>
                                            <div class="col-lg-8">
