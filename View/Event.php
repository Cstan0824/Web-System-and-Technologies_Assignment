                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        ...
                                        <p style="text-align:right;" id="searchContent">
                                            Showing <span id="searchCount">0</span> result > <span
                                                id="searchInput"></span>
                                        </p>
                                            ...
                                            <table class="table table-hover">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="number"><i class=" fa-regular fa-pen-to-square"
                                                                style="color: #007aff;"></i></th>
                                                        <th class="number"><i class="fa-regular fa-trash-can"
                                                                style="color: #007aff;"></i></th>
                                                    </tr>
                                                </thead>
                                            </table>
